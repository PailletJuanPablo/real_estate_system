                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" required name="client_id">
                                    ...
                                    <option @isset($contact) @if ($contact->client_id == $sclient->id) selected @endif
                                        @endisset
                                        value="{{$client->id}}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="aclarations" id="aclarations"
                                    placeholder="Escribir aquí"> @isset($contact) {{$contact->aclarations}} @endisset </textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
<script src="{{ asset('js/contactes.js') }}" type="text/javascript"></script>
